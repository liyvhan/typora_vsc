...
export class MarkdownEditorProvider implements vscode.CustomTextEditorProvider {
	...
	private static readonly viewType = 'typoraVsc.editor';
	...
	public async resolveCustomTextEditor(
		...
		webviewPanel.webview.html = this.getHtmlForWebview(webviewPanel.webview, scriptUri, styleUri, vditorAssetUri, initialText);
	...
	private handleOpenLink(document: vscode.TextDocument, href: string) {
	...
	private getHtmlForWebview(webview: vscode.Webview, scriptUri: vscode.Uri, styleUri: vscode.Uri, vditorAssetUri: vscode.Uri): string {
		return `
			<!DOCTYPE html>
			<html lang="en">
			<head>
